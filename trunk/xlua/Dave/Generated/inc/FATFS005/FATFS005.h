 ...
 *        prototypes for Device Abstraction Layer App in RTOS environment.
 *
 */
 ...
 */
#define  FATFS005_NODISK_NOINIT                3
 ...
 */
typedef enum FATFS005_ErrorCodesType
{
  /**
  ...
  */
   ...
   */
  /*
  ERRCODESTRING = FATFS005_FUNCTION_ENTRY
  STRCODESTRING = Function Entered %s
  */
  FATFS005_FUNCTION_ENTRY,
  /**
   * DebugLog Message Id for Function Exit (1)
   */
  /*
  ERRCODESTRING = FATFS005_FUNCTION_EXIT
  STRCODESTRING = Function Exited %s
  */
  FATFS005_FUNCTION_EXIT
} FATFS005_ErrorCodesType;
 ...
 * as member fields
 */
typedef struct FATFS005_DeviceFuncType
{
/**
