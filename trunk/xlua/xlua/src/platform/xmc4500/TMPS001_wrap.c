...
#define SWIGTYPE_p_uint32_t swig_types[0]
...
#define SWIG_name      "TMPS001"
#define SWIG_init      luaopen_TMPS001
#define SWIG_init_user luaopen_TMPS001_user

#define SWIG_LUACODE   luaopen_TMPS001_luacode
#define swig_commands  TMPS001_map
...
extern "C" {
#endif
static int _wrap_StartMeasurement(lua_State* L) {
  int SWIG_arg = 0;
  unsigned int result;
  
  SWIG_check_num_args("TMPS001_StartMeasurement",0,0)
  result = (unsigned int)TMPS001_StartMeasurement();
...
static int _wrap_ReadTemp(lua_State* L) {
  int SWIG_arg = 0;
  unsigned int result;
  
  SWIG_check_num_args("TMPS001_ReadTemp",0,0)
  result = (unsigned int)TMPS001_ReadTemp();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_GetStatus(lua_State* L) {
  int SWIG_arg = 0;
  unsigned int result;
  
  SWIG_check_num_args("TMPS001_GetStatus",0,0)
  result = (unsigned int)TMPS001_GetStatus();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_Enable(lua_State* L) {
  ...
  SWIG_check_num_args("Enable",0,0)
  Enable();
...
static int _wrap_Disable(lua_State* L) {
  int SWIG_arg = 0;
  
  SWIG_check_num_args("Disable",0,0)
  Disable();
...
static const LUA_REG_TYPE swig_constants[];
static const LUA_REG_TYPE mt[];

const LUA_REG_TYPE swig_commands[] = {
    {LSTRKEY("StartMeasurement"), LFUNCVAL(_wrap_StartMeasurement)},
    {LSTRKEY("ReadTemp"), LFUNCVAL(_wrap_ReadTemp)},
    {LSTRKEY("GetStatus"), LFUNCVAL(_wrap_GetStatus)},
    {LSTRKEY("Enable"), LFUNCVAL(_wrap_Enable)},
    {LSTRKEY("Disable"), LFUNCVAL(_wrap_Disable)},
    {LSTRKEY("const"), LROVAL(swig_constants)},
    {LSTRKEY("__metatable"), LROVAL(mt)},
    {LNILKEY, LNILVAL}
};

static const LUA_REG_TYPE dot_get[] = {
    {LNILKEY, LNILVAL}
};

static const LUA_REG_TYPE dot_set[] = {
    {LNILKEY, LNILVAL}
};
...
const LUA_REG_TYPE swig_constants[] = {
    {SWIG_LUA_CONSTTAB_INT("DISABLE", TMPS001_DISABLE)},
    {SWIG_LUA_CONSTTAB_INT("ENABLE", TMPS001_ENABLE)},
    {SWIG_LUA_CONSTTAB_INT("FAIL", TMPS001_FAIL)},
    {SWIG_LUA_CONSTTAB_INT("BUSY", TMPS001_BUSY)},
    {SWIG_LUA_CONSTTAB_INT("READY", TMPS001_READY)},
    {LNILKEY, LNILVAL}
};

/* -------- TYPE CONVERSION AND EQUIVALENCE RULES (BEGIN) -------- */

static swig_type_info _swigt__p_uint32_t = {"_p_uint32_t", "uint32_t *|status_t *", 0, 0, (void*)0, 0};
