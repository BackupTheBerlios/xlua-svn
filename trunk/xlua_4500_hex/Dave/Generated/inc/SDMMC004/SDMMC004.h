 ...
 * #include <DAVE3.h>
 *
 * void SDMMC004_MainTask(void const *Argument)
 * {
 ...
 *   osThreadId ThreadId;
 *   //Thread definition 
 *   osThreadDef(SDMMC004_MainTask, osPriorityBelowNormal, 1, 0);
 *   ThreadId = osThreadCreate(osThread(SDMMC004_MainTask),NULL);
 *   if (ThreadId != NULL )
 *   {
